    ...
    <div>
        @if($showLogin)
            ...
            <p class="mt-4 text-sm text-gray-600 dark:text-gray-400 text-center">
                ...
                <button wire:click="$set('showLogin', false)" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 focus:outline-none transition-colors duration-200">
                    Register here
                </button>
            </p>
        @else
            ...
            <p class="mt-4 text-sm text-gray-600 dark:text-gray-400 text-center">
                ...
                <button wire:click="$set('showLogin', true)" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 focus:outline-none transition-colors duration-200">
                    Sign in here
                </button>
            </p>
        @endif
